...
# like this:
# 1783621,Zunyi,http://www.eguizhou.gov.cn/2013-09/18/content_16979121.htm, http://www.blah.gov.cn/2013-09/18/content_16979121.htm
...
IMPORT_DIR = os.path.join(BASE_DIR, "static", "import","curator")
				...
				if idx == 0:
					...
					for city in CITIES:
						if city["geonames_id"] == cityID:
							print "Matched " + cityName + " to " + city["city_name"]
							primaryCity = city
